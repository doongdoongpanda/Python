...
public class examtable_2 { //클래스를 연다.
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		Statement k29_stmt = k29_conn.createStatement(); //Connection 객체의 createStatement() 메서드를 호출하여, 쿼리를 실행할 수 있는 Statement 객체( stmt)를 얻는다.
		k29_stmt.execute("delete from examtable;"); //ResultSet이 없는 경우, execute method로 실행.
